...
- You can read more about collaborative editing handling here: [Handling Write Conflicts in Collaborative Editing](/blog/handling-write-conflicts-in-multi-leader-replication)
...
![image](/blog/multi-leader-conflict.png)
...
![With multi-leader replication, writes may arrive in the wrong order at some replicas](/blog/multi-leader-wrong-order.png)
