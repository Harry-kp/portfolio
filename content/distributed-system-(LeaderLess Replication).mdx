...
![A quorum write, quorum read, and read repair after a node outage](/blog/quorum-write-read.png)
...
You can read about this in detail here: [Quorums for reading and writing](/blog/quorums-reads-and-writes)
...
> We briefly touched on some techniques for conflict resolution in [Handling Write Conflicts](/blog/handling-write-conflicts-in-multi-leader-replication)
...
[Read about Version Vectors](/blog/version-vectors)
